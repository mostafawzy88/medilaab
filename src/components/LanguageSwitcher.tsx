...
export default function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      disabled={isPending}
      className="fixed top-6 right-6 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md px-4 py-2 rounded-full border border-gray-200 dark:border-gray-800 shadow-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-all font-bold text-sm tracking-wide cursor-pointer flex items-center gap-2"
    >
